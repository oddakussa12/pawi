...
.row .col-md-4 .wrap{border-bottom: 1px solid #CFCFCF;
    ...
    border-radius: 3px;
    border-color: rgb(119, 119, 119) rgb(119, 119, 119) #a4c639 rgb(119, 119, 119);
  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="index.html"><h2>Pawi Health Science Collage</h2></a>
    ...
    <div class="container col-gap-50" style="margin-top:70px;max-width:1120px;">
      <div class="row text-center">
        <div class="col-md-4" style="padding-bottom:50px;">
          <div class="wrap" style="height:400px;">
            <h2 style="padding-bottom:10px;">Our Mission</h2>
            
            <div class="row text-left" style="width:100%;padding-bottom:10px;">
              <div class="column" style="width:5%;">
                <i class="fa fa-check" aria-hidden="true"></i>
              </div>
              <div class="column" style="width:80%;">
                <p style="padding:0px;">
                  Provide demand based practical training to produce skilled and self-reliant manpower for aspiring and currently operating healthcare industry.
                </p>
              </div>
            </div>
            ...
            <div class="row text-left" style="width:100%;">
              ...
              <div class="column" style="width:80%;">
                <p>
                  To assist the growth of national economy by under taking scientific research.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-4" style="padding-bottom:50px;">
          <div class="wrap" style="height:400px;">
            <h2 style="padding-bottom:10px;">Our Vision</h2>
            ...
            <div class="row text-left" style="width:100%;padding-bottom:10px;">
              ...
              <div class="column" style="width:80%;">
                <p style="padding:0px;">
                  By 2028G.C to be reputable training institution in training of competent and disciplined mid and high level health care professions that who will be respectful, compassionate and care to satisfy the need of the health industry.   
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-4" style="padding-bottom:50px;">
          <div class="wrap" style="height:400px;">
            <h2 style="padding-bottom:10px;">Core Values</h2>
            ...
            <div class="row text-left" style="width:100%;padding-bottom:10px;">
              ...
              <div class="column" style="width:80%;">
                <p style="padding:0px;">Quality of service</p>
              </div>
            </div>
            ...
            <div class="row text-left" style="width:100%;padding-bottom:10px;">
              ...
              <div class="column" style="width:80%;">
                <p style="padding:0px;">Demand based training</p>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="count-area-content">
                  <div class="count-digit">71</div>
                  <div class="count-title">Admin Staffs</div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="count-area-content">
                  <div class="count-digit">50</div>
                  <div class="count-title">Acadamic Staffs</div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="count-area-content">
                  <div class="count-digit">230</div>
                  <div class="count-title">Enrollment Plan</div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="count-area-content">
